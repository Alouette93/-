...
/************************* PLL Parameters *************************************/
 ...
 #define PLL_M      8  //ÐÞ¸ÄPLL·ÖÆµ25Îª8£¬¼´8·ÖÆµ£»
#elif defined (STM32F446xx)
 #define PLL_M      8
#elif defined (STM32F410xx) || defined (STM32F411xE)
 #if defined(USE_HSE_BYPASS)//ÈôÊ¹ÓÃÍâ²¿Ê±ÖÓ£¬8·ÖÆµ£»
  #define PLL_M      8    
 #else /* !USE_HSE_BYPASS *///ÈôÊ¹ÓÃÄÚ²¿Ê¼ÖÕ£¬16·ÖÆµ
  #define PLL_M      16
 #endif /* USE_HSE_BYPASS */
#else
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;//ÐÞ¸ÄÎªDIV2
    
    /* PCLK1 = HCLK / 4*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;//ÐÞ¸ÄÎªDIV4
